...
schema = _load_phase_impl("03_schema")  # type: ignore
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 03 schema validation")
...
def main() -> int:
    ...
    result: Dict[str, Any] = schema.run(args.run_id, inputs, cfg)  # type: ignore[assignment]
    _emit_json(result)
