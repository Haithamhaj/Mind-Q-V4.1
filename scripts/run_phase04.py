...
profile = _load_phase_impl("04_profile")  # type: ignore
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Phase 04 profiling")
...
def main() -> int:
    ...
    result: Dict[str, Any] = profile.run(args.run_id, inputs, cfg)  # type: ignore[assignment]
    _emit_json(result)
