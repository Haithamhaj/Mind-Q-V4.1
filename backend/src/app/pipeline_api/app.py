...
from backend.src.app.services.stage_07_knime_bridge import impl as knime_bridge_impl
...
PHASE_MODULES = {
    ...
    "07_knime_bridge": "backend.src.app.services.stage_07_knime_bridge.impl",
    "08_insights": "backend.src.app.services.stage_08_insights.impl",
    "09_business_validation": "phases.09_business_validation.impl",
    "09_5_causal": "backend.src.app.services.stage_09_5_causal_inference.impl",
...
async def run_phase09_5(run_id: str, request: PhaseRequest) -> Dict[str, Any]:
    ...
    try:
        from backend.src.app.services.stage_09_5_causal_inference.impl import run as run_causal
